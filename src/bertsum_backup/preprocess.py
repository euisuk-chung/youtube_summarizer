...
if __name__ == "__main__":
    ...
    parser.add_argument("-raw_path", default="./datasets/kor_data/신문기사/")
    parser.add_argument("-json_path", default="./datasets/kor_data/bertsum/json_data/news/")
    parser.add_argument("-save_path", default="./datasets/kor_data/bertsum/bert_data/news/")
    ...
    os.makedirs(os.path.split(args.log_file)[0], exist_ok=True)
